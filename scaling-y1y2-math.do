...
scale_transformation, type(1) score1(math_mle1) score2(math_mle2) compgroup(reportcard) iterations(500) robust(50) monotonicity(1) save("$gituser/scaling/math-iterations500-y2-max.dta")  
...
scale_transformation, type(2) score1(math_mle1) score2(math_mle2) compgroup(reportcard) iterations(500) robust(50) monotonicity(1) save("$gituser/scaling/math-iterations500-y2-min.dta")

* Scale transformation : max correlation

use "$gituser/2_build/testcores_y1y2_wide.dta", clear

scale_transformation, type(3) score1(math_mle1) score2(math_mle2) iterations(500) monotonicity(1) save("$gituser/scaling/math-iterations500-y2-corr.dta")

* Scale transformation : max r2

use "$gituser/2_build/testcores_y1y2_wide.dta", clear

scale_transformation, type(5) score1(math_mle1) score2(math_mle2) iterations(500) monotonicity(1) save("$gituser/scaling/math-iterations500-y2-r2.dta")
